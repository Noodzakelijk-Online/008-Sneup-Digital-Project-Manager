...
| ENH-004 | P1 | Trust | Recommendations include inspectable, validated source evidence, and the approval workspace now summarizes worker follow-ups, responses, overdue work, and escalations without exposing response text. | Extend source drilldowns into chat and notifications. |
