...
| ENH-017 | P1 | Autonomy safety | Workspace managers can pause individual Trello action types or raise their risk/owner posture. The executor rechecks the effective policy immediately before its atomic claim, and the command center exposes bounded workspace policy history from the audit ledger. | Add optional time-bound emergency pauses with expiry review. |
