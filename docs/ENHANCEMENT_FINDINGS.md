...
| ENH-005 | P1 | Forecasting | Sneup now models workspace-scoped weekly capacity, allocation, focus time, planned time off, skills, historical card effort, bounded Harvest utilization, and explicit Float or Resource Guru member mappings to return analysis-only P50/P80 ranges with confidence, assumptions, and delivery risks. Only mapped, approved scheduling evidence calibrates confidence or raises capacity mismatch risks. | Add calendar availability evidence only with explicit member mapping. |
