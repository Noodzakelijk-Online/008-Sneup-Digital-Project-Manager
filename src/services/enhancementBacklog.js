...
const enhancements = [
  ...
  },
  {
    ...
    impact: 'Cuts avoidable initial API, authentication, transport, and dashboard-read memory work while keeping each view responsive and preserving ledger evidence.',
    effort: 'S',
    status: 'done',
