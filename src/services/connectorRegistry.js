...
const CONNECTORS = [
  ...
  { id: 'clockify', name: 'Clockify', category: 'time_finance', description: 'Read-only bounded project and personal time-entry utilization metadata. Sneup excludes descriptions, tags, clients, people, rates, and custom fields.', auth: apiKey({ docsUrl: 'https://docs.clockify.me/', fields: [{ name: 'workspaceId', label: 'Clockify workspace ID', placeholder: '64a687e29ae1f428e7ebe303', required: true }, { name: 'apiKey', label: 'API key', secret: true, required: true }] }), sync: ['time_entries', 'projects'] },
